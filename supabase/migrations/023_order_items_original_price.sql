...
BEGIN
  ...
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
    ...
    VALUES (
      v_order_id, v_menu.id, v_menu.name, v_unit_price, (v_item->>'original_price')::NUMERIC, v_qty,
      v_unit_price * v_qty,
